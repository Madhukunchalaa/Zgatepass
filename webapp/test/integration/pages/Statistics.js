			...
			assertions: {
				...
				iShouldSeeTheCharts: function () {
					if (sChartViewName.search("D3") >= 0) {
						this.waitFor({
							controlType: "zgpms.meilpower.com.control.D3PieChart",
							viewName: sChartViewName,
						...
						this.waitFor({
							controlType: "zgpms.meilpower.com.control.D3ColumnChart",
							viewName: sChartViewName,
							success: function (aCharts) {
						...
						this.waitFor({
							controlType: "zgpms.meilpower.com.control.D3ComparisonChart",
							viewName: sChartViewName,
							success: function (aCharts) {
						...
						this.waitFor({
							controlType: "zgpms.meilpower.com.control.D3Chart",
							viewName: sChartViewName,
							success: function (aCharts) {
