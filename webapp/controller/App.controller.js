sap.ui.define([
	...
	return BaseController.extend("zgpms.meilpower.com.controller.App", {
		...
		onInit: function() {
			...
			// console.log("This is Lakshmi Om Namo Bhagavathe Vasudevaya Namah");
		...
		onSideNavButtonPress: function() {
			console.log("on Side Nav Button Press");
			var oToolPage = this.byId("app");
				console.log("1 on Side Nav Button Press");
			var bSideExpanded = oToolPage.getSideExpanded();
				console.log("2 on Side Nav Button Press");
			// this._setToggleButtonTooltip(bSideExpanded);
				console.log("3 on Side Nav Button Press");
			oToolPage.setSideExpanded(!oToolPage.getSideExpanded());
				console.log("4 on Side Nav Button Press");
		},
